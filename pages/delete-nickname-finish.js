  ...
  return (
    <div className="body-div">
      <div className="details-div">
        <div className="details-div-holder">
          ...
          <div className="title-div">
            <div className="title-text">Your Username has been deleted</div>
          </div>
          <div className="div-block-7">
            <Link href="/username-registration">
              <a className="link-block w-inline-block">
                <div>Create a new Nickname</div>
              </a>
            </Link>
          </div>
        </div>
      ...
      <div className="pic-div">
        ...
        <img src="images/img12.png" loading="lazy" alt="" className="bg-img" />
...
export default deleteNicknameFinish;
